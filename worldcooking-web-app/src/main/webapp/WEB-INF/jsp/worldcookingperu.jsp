<html>
    ...
    <body onload="javascript:cleanInputs(['name1_field','name2_field']);">
        <div class="main_chapter">
			<h2>Informations</h2>
			<p>
				Up to 39 persons will share a peruvian meal in the restaurant La
				soupe au Caillou.<br /> Our chef will be Nidia Torres.<br /> <br />
				...
				we ask each person to help. When registering you have to choose a
				task from the following ones:<br /> - Cooking with Nidia from 4pm<br />
			...
			<div class="main_chapter">
				...
				<p>
					...
					Matthieu, Nidia, Ben, Nicolas or Toub, but your registration will
					be validated only when you give them the money.<br />
				</p>
				<form>
