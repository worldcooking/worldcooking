...
<html>
<head>
	<resources:require-css resourceURI="site/admin/main/worldcooking-admin-main.css"/>
	<title>Worldcooking - administration</title>
	<jquery:require-static-resources />
	<resources:require-script resourceURI="site/admin/events/worldcooking-admin-events.js" />
</head>
<body>
